function PerfumerCourt370000_Logic(arg0)
...
function PerfumerCourt370000_Interupt(arg0, arg1)
    if arg0:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg0:HasSpecialEffectId(TARGET_SELF, 14437) and arg0:HasSpecialEffectId(TARGET_SELF, PLAN_SP_EFFECT_BUDDY_DECLARE) and arg0:HasSpecialEffectId(TARGET_SELF, 14411) then
        arg1:ClearSubGoal()
        local f2_local0 = 5
        local f2_local1 = 3003

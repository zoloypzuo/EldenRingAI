RegisterTableGoal(GOAL_Skeleton_351008_Battle, "Skeleton_351008_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_Skeleton_351008_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local1[1] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act01)
    f2_local1[2] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act02)
    f2_local1[3] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act03)
    f2_local1[4] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act04)
    f2_local1[5] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act05)
    f2_local1[6] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act06)
    f2_local1[7] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act07)
    f2_local1[20] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act20)
    f2_local1[21] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act21)
    f2_local1[22] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act22)
    f2_local1[23] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act23)
    f2_local1[24] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act24)
    f2_local1[25] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act25)
    f2_local1[28] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act28)
    f2_local1[30] = REGIST_FUNC(arg1, arg2, Skeleton_351008_Act30)
    local f2_local9 = REGIST_FUNC(arg1, arg2, Skeleton_351008_ActAfter_AdjustSpace)
    Common_Battle_Activate(arg1, arg2, f2_local0, f2_local1, f2_local9, f2_local2)
    
end

function Skeleton_351008_Act01(arg0, arg1, arg2)
    local f3_local0 = 3.5 - arg0:GetMapHitRadius(TARGET_SELF)
    local f3_local1 = 3.5 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9
    local f3_local2 = 3.5 - arg0:GetMapHitRadius(TARGET_SELF) + 4
    local f3_local3 = 0
    local f3_local4 = 0
    local f3_local5 = 2
    local f3_local6 = 3
    ...
    local f3_local10 = 3011
    local f3_local11 = 2.4 - arg0:GetMapHitRadius(TARGET_SELF) + 1
    local f3_local12 = 3.2 - arg0:GetMapHitRadius(TARGET_SELF) + 1
    local f3_local13 = 2.8 - arg0:GetMapHitRadius(TARGET_SELF) + 1
    local f3_local14 = 8 - arg0:GetMapHitRadius(TARGET_SELF)
    local f3_local15 = 0
    local f3_local16 = 0
    local f3_local17 = arg0:GetRandam_Int(1, 100)
    if f3_local17 <= 10 then
        arg1:AddSubGoal(GOAL_COMMON_AttackTunableSpin, 10, f3_local7, TARGET_ENE_0, f3_local14, f3_local15, f3_local16, 0, 0)
    elseif f3_local17 <= 30 then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, f3_local7, TARGET_ENE_0, f3_local11, f3_local15, f3_local16, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, f3_local8, TARGET_ENE_0, f3_local14, 0, 0)
    elseif f3_local17 <= 60 then
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, f3_local7, TARGET_ENE_0, f3_local11, f3_local15, f3_local16, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, f3_local8, TARGET_ENE_0, f3_local12, f3_local15, f3_local16, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, f3_local9, TARGET_ENE_0, f3_local14, 0, 0)
    else
        arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, f3_local7, TARGET_ENE_0, f3_local11, f3_local15, f3_local16, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, f3_local8, TARGET_ENE_0, f3_local13, f3_local15, f3_local16, 0, 0)
        arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, f3_local10, TARGET_ENE_0, f3_local14, 0, 0)
    end
...
function Skeleton_351008_Act02(arg0, arg1, arg2)
...
function Skeleton_351008_Act03(arg0, arg1, arg2)
    local f5_local0 = 3.3 - arg0:GetMapHitRadius(TARGET_SELF)
    local f5_local1 = 3.3 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9
    local f5_local2 = 3.3 - arg0:GetMapHitRadius(TARGET_SELF) + 4
    local f5_local3 = 0
    local f5_local4 = 0
    local f5_local5 = 2
    local f5_local6 = 3
    ...
    local f5_local8 = 8 - arg0:GetMapHitRadius(TARGET_SELF) + 1
    local f5_local9 = 0
    local f5_local10 = 0
...
function Skeleton_351008_Act04(arg0, arg1, arg2)
    local f6_local0 = 3.1 - arg0:GetMapHitRadius(TARGET_SELF)
    local f6_local1 = 3.1 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9
    local f6_local2 = 3.1 - arg0:GetMapHitRadius(TARGET_SELF) + 4
    local f6_local3 = 0
    local f6_local4 = 0
    local f6_local5 = 2
    local f6_local6 = 3
...
function Skeleton_351008_Act05(arg0, arg1, arg2)
    local f7_local0 = 8.3 - arg0:GetMapHitRadius(TARGET_SELF)
    local f7_local1 = 8.3 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9
    local f7_local2 = 8.3 - arg0:GetMapHitRadius(TARGET_SELF) + 4
    local f7_local3 = 0
    local f7_local4 = 0
    local f7_local5 = 2
    local f7_local6 = 3
...
function Skeleton_351008_Act06(arg0, arg1, arg2)
    local f8_local0 = 10 - arg0:GetMapHitRadius(TARGET_SELF)
    local f8_local1 = 10 - arg0:GetMapHitRadius(TARGET_SELF) + 0.9
    local f8_local2 = 10 - arg0:GetMapHitRadius(TARGET_SELF) + 4
    local f8_local3 = 0
    local f8_local4 = 0
    local f8_local5 = 2
    local f8_local6 = 3
...
function Skeleton_351008_Act07(arg0, arg1, arg2)
...
function Skeleton_351008_Act20(arg0, arg1, arg2)
...
function Skeleton_351008_Act21(arg0, arg1, arg2)
...
function Skeleton_351008_Act22(arg0, arg1, arg2)
...
function Skeleton_351008_Act23(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_StepSafety, 2, -1, -1, 1, -1, TARGET_ENE_0, 4, 0, true)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
function Skeleton_351008_Act24(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_StepSafety, 2, 1, -1, -1, -1, TARGET_ENE_0, 4, 0, true)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
function Skeleton_351008_Act25(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_StepSafety, 2, -1, 1, -1, -1, TARGET_ENE_0, 4, 0, true)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
function Skeleton_351008_Act28(arg0, arg1, arg2)
...
function Skeleton_351008_Act30(arg0, arg1, arg2)
...
function Skeleton_351008_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_Skeleton_351008_AfterAttackAct, 10)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if Damaged_Act(arg1, arg2, f21_local0, f21_local1) then
        if f21_local2 >= 8 then
            arg2:ClearSubGoal()
            Skeleton_351008_Act24(arg1, arg2, paramTbl)
...
RegisterTableGoal(GOAL_Skeleton_351008_AfterAttackAct, "Skeleton_351008_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_Skeleton_351008_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)

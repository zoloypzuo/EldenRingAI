RegisterTableGoal(GOAL_AncestorBelieverSpecial336020_Battle, "AncestorBelieverSpecial336020_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_AncestorBelieverSpecial336020_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    elseif f2_local5 == 1 and arg1:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        ...
        if arg1:HasSpecialEffectId(TARGET_ENE_0, 13175) then
            f2_local0[7] = 0
        end
    elseif arg1:HasSpecialEffectId(TARGET_SELF, 13152) then
    ...
    f2_local0[1] = SetCoolTime(arg1, arg2, 3032, 10, f2_local0[1], 5)
    f2_local0[2] = SetCoolTime(arg1, arg2, 3032, 10, f2_local0[1], 5)
    f2_local0[4] = SetCoolTime(arg1, arg2, 3005, 10, f2_local0[4], 0)
    f2_local0[5] = SetCoolTime(arg1, arg2, 3006, 10, f2_local0[5], 0)
    f2_local0[6] = SetCoolTime(arg1, arg2, 3020, 10, f2_local0[6], 5)
    f2_local0[7] = SetCoolTime(arg1, arg2, 3022, 20, f2_local0[7], 0)
    f2_local0[9] = SetCoolTime(arg1, arg2, 3039, 15, f2_local0[9], 0)
    f2_local1[1] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act01)
    f2_local1[2] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act02)
    f2_local1[3] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act03)
    f2_local1[4] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act04)
    f2_local1[5] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act05)
    f2_local1[6] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act06)
    f2_local1[7] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act07)
    f2_local1[9] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act09)
    f2_local1[40] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act40)
    f2_local1[41] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act41)
    f2_local1[42] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act42)
    f2_local1[43] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act43)
    f2_local1[44] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act44)
    f2_local1[45] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act45)
    f2_local1[46] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act46)
    f2_local1[49] = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_Act49)
    local f2_local7 = REGIST_FUNC(arg1, arg2, AncestorBelieverSpecial336020_ActAfter_AdjustSpace)
    Common_Battle_Activate(arg1, arg2, f2_local0, f2_local1, f2_local7, f2_local2)
    
end

function AncestorBelieverSpecial336020_Act01(arg0, arg1, arg2)
    local f3_local0 = 4
    local f3_local1 = 0
    local f3_local2 = 0
    local f3_local3 = 100
...
function AncestorBelieverSpecial336020_Act02(arg0, arg1, arg2)
    local f4_local0 = 4.5
    local f4_local1 = 0
    local f4_local2 = 0
    local f4_local3 = 100
...
function AncestorBelieverSpecial336020_Act03(arg0, arg1, arg2)
    arg0:AddObserveSpecialEffectAttribute(TARGET_SELF, 5025)
...
function AncestorBelieverSpecial336020_Act04(arg0, arg1, arg2)
...
function AncestorBelieverSpecial336020_Act05(arg0, arg1, arg2)
...
function AncestorBelieverSpecial336020_Act06(arg0, arg1, arg2)
    local f8_local0 = 4.2
    local f8_local1 = 0
    local f8_local2 = 0
    local f8_local3 = 100
...
function AncestorBelieverSpecial336020_Act07(arg0, arg1, arg2)
    local f9_local0 = 9
    local f9_local1 = 0
    local f9_local2 = 0
    local f9_local3 = 100
    ...
    local f9_local10 = 0
    local f9_local11 = 120
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, f9_local7, f9_local8, TARGET_LowHp_Friend, f9_local9, f9_local10, f9_local11, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

function AncestorBelieverSpecial336020_Act09(arg0, arg1, arg2)
    local f10_local0 = 6
    local f10_local1 = 0
    local f10_local2 = 0
...
function AncestorBelieverSpecial336020_Act40(arg0, arg1, arg2)
    local f11_local0 = 2
    local f11_local1 = 8
...
function AncestorBelieverSpecial336020_Act41(arg0, arg1, arg2)
    local f12_local0 = 2
    local f12_local1 = 8
...
function AncestorBelieverSpecial336020_Act42(arg0, arg1, arg2)
...
function AncestorBelieverSpecial336020_Act43(arg0, arg1, arg2)
    local f14_local0 = 3
    local f14_local1 = 0
...
function AncestorBelieverSpecial336020_Act44(arg0, arg1, arg2)
...
function AncestorBelieverSpecial336020_Act45(arg0, arg1, arg2)
    local f16_local0 = 6
    local f16_local1 = 15
...
function AncestorBelieverSpecial336020_Act46(arg0, arg1, arg2)
    local f17_local0 = 3
...
function AncestorBelieverSpecial336020_Act49(arg0, arg1, arg2)
    local f18_local0 = 5
    local f18_local1 = 10
    local f18_local2 = -1
...
function AncestorBelieverSpecial336020_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_AncestorBelieverSpecial336020_AfterAttackAct, 10)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_Damaged) then
        if f22_local3 > 3.5 or arg1:GetTimer(2) > 0 then
            return false
        elseif arg1:HasSpecialEffectId(TARGET_SELF, 13152) and f22_local4 < 30 then
            arg2:ClearSubGoal()
        ...
        elseif arg1:HasSpecialEffectId(TARGET_SELF, 13152) == false and arg1:GetHpRate(TARGET_SELF) < 1 and arg1:HasSpecialEffectId(TARGET_SELF, 13170) then
            ...
            return true
        elseif not arg1:HasSpecialEffectId(TARGET_SELF, 13152) and f22_local4 < 30 then
            arg1:SetTimer(2, 8)
            arg2:ClearSubGoal()
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) then
        if arg1:HasSpecialEffectId(TARGET_SELF, 5026) then
            if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 240, -1, 6 + arg1:GetMapHitRadius(TARGET_SELF)) then
                arg2:ClearSubGoal()
                arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 1.6, 3034, TARGET_ENE_0, 0, 0, 0, 0, 0)
                return true
            end
        elseif arg1:HasSpecialEffectId(TARGET_SELF, 5027) then
            if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, -1, 10 + arg1:GetMapHitRadius(TARGET_SELF)) and arg1:GetTimer(2) <= 0 then
                arg2:ClearSubGoal()
                arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 5, 3020, TARGET_ENE_0, 0, 0, 0, 0, 0)
                return true
        ...
        elseif arg1:HasSpecialEffectId(TARGET_SELF, 5029) then
            if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 240, -1, 8) then
                arg1:SetTimer(2, 8)
                arg2:ClearSubGoal()
                arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 3.2, 3021, TARGET_ENE_0, 0, 0, 0, 0, 0)
                return true
            end
        elseif arg1:HasSpecialEffectId(TARGET_SELF, 5030) then
            if f22_local3 < 15 then
                arg2:ClearSubGoal()
                arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, 3.2, 3023, TARGET_ENE_0, 0, 0, 0, 0, 0)
                return true
            end
...
RegisterTableGoal(GOAL_AncestorBelieverSpecial336020_AfterAttackAct, "AncestorBelieverSpecial336020_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_AncestorBelieverSpecial336020_AfterAttackAct, true)
Goal.Update = function (arg0, arg1, arg2)
    return Update_Default_NoSubGoal(arg0, arg1, arg2)

function DemiHumanRunt_411000_Logic(arg0)
    ...
    if COMMON_EasySetup_Initial(arg0) == false then
        ...
        if arg0:HasSpecialEffectId(TARGET_SELF, 10575) == true then
            arg0:AddTopGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 10, 3038, TARGET_ENE_0, 999, 0, 0, 0, 0)
        elseif arg0:HasSpecialEffectId(TARGET_SELF, 10574) == true then
        ...
        elseif f1_local3 == PLAN_TIME_TYPE_NIGHT or f1_local3 == PLAN_TIME_TYPE_MIDNIGHT then
            if arg0:HasSpecialEffectId(TARGET_SELF, PLAN_SP_EFFECT_BUDDY_DECLARE) == true then
                if arg0:HasSpecialEffectId(TARGET_SELF, 10571) == true then
                    COMMON_EasySetup3(arg0)
                elseif arg0:HasSpecialEffectId(TARGET_SELF, 10571) == false then
            ...
            elseif arg0:HasSpecialEffectId(TARGET_SELF, PLAN_SP_EFFECT_BUDDY_DECLARE) == false then
                if arg0:HasSpecialEffectId(TARGET_SELF, 10573) == true then
                ...
                elseif arg0:HasSpecialEffectId(TARGET_SELF, 10571) == true then
                    if arg0:IsBattleState() == true or arg0:IsSearchLowState() == true or arg0:IsSearchHighState() == true or arg0:IsCautionState() == true then
                        COMMON_EasySetup3(arg0)
                    else
                        arg0:AddTopGoal(GOAL_COMMON_WalkAround_Anywhere, -1, 2, 10, true, -1, 3, 1, false, false)
...
function DemiHumanRunt_411000_Interupt(arg0, arg1)
    
end

function DemiHumanRunt_411000_NoneBattleCheck(arg0)

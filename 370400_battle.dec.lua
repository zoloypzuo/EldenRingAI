RegisterTableGoal(GOAL_MagicMercenary_370400_Battle, "MagicMercenary_370400_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_MagicMercenary_370400_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local0[6] = SetCoolTime(arg1, arg2, 3010, 3, f2_local0[6], 1)
    f2_local0[7] = SetCoolTime(arg1, arg2, 3011, 15, f2_local0[7], 1)
    f2_local0[8] = SetCoolTime(arg1, arg2, 3012, 10, f2_local0[8], 1)
    f2_local1[1] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act1)
    f2_local1[2] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act2)
    f2_local1[3] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act3)
    f2_local1[4] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act4)
    f2_local1[5] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act5)
    f2_local1[6] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act6)
    f2_local1[7] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act7)
    f2_local1[8] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act8)
    f2_local1[20] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act20)
    f2_local1[21] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act21)
    f2_local1[22] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act22)
    f2_local1[23] = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_Act23)
    local f2_local9 = REGIST_FUNC(arg1, arg2, MagicMercenary_370400_ActAfter_AdjustSpace)
    Common_Battle_Activate(arg1, arg2, f2_local0, f2_local1, f2_local9, f2_local2)
    
end

function MagicMercenary_370400_Act1(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act2(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act3(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act4(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act5(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act6(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act7(arg0, arg1, arg2)
    local f9_local0 = 13.5 - arg0:GetMapHitRadius(TARGET_SELF)
...
function MagicMercenary_370400_Act8(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act20(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act21(arg0, arg1, arg2)
...
function MagicMercenary_370400_Act22(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, arg0:GetRandam_Float(2, 2.5), TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
function MagicMercenary_370400_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_MagicMercenary_370400_AfterAttackAct, 10)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_UseItem) and arg1:HasSpecialEffectId(TARGET_SELF, 5039) == false then
        if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 4.5) then
            if f17_local4 <= 70 then
                ...
                arg2:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 15, 3000, TARGET_ENE_0, 999, 0, 0, 0, 0)
                return true
            else
                return true
            end
        ...
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 20) then
            if f17_local4 <= 70 then
                ...
                arg2:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 15, 3010, TARGET_ENE_0, 999, 0, 0, 0, 0)
                return true
            else
                return true
            end
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:HasSpecialEffectId(TARGET_ENE_0, 30) == true and arg1:HasSpecialEffectId(TARGET_SELF, 5039) == false and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 4) then
        if f17_local4 <= 70 then
            arg2:ClearSubGoal()
            arg1:AddObserveSpecialEffectAttribute(TARGET_SELF, 5030)
            arg1:AddObserveSpecialEffectAttribute(TARGET_SELF, 5031)
            ...
            arg1:AddObserveSpecialEffectAttribute(TARGET_SELF, 5036)
            arg1:AddObserveSpecialEffectAttribute(TARGET_SELF, 5037)
            arg2:AddSubGoal(GOAL_COMMON_ComboTunable_SuccessAngle180, 15, 3012, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        else
            return true
        end
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5025) and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 180, 180, 4) then
        arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3001, TARGET_ENE_0, 999, f17_local2, f17_local3, 0, 0)
        return true
    end
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5027) and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 180, 180, 4) then
        if f17_local4 <= 30 then
            arg2:AddSubGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, 10, 3003, TARGET_ENE_0, 999, 0, 0)
            return true
        else
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3004, TARGET_ENE_0, 999, f17_local2, f17_local3, 0, 0)
            return true
        end
    end
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5029) and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 240, 180, 4.5) then
        if f17_local4 <= 80 then
            arg2:AddSubGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, 10, 3012, TARGET_ENE_0, 999, 0, 0)
            return true
        else
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5030) and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 360, 180, 4.5) then
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5031) then
        ...
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 9.5) then
            if f17_local4 <= 70 then
                arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3010, TARGET_ENE_0, 999, f17_local2, f17_local3, 0, 0)
                return true
            else
                return true
            end
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 15) then
            if f17_local4 <= 30 then
                arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3010, TARGET_ENE_0, 999, f17_local2, f17_local3, 0, 0)
                return true
            elseif f17_local4 <= 90 then
                arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3011, TARGET_ENE_0, 999, f17_local2, f17_local3, 0, 0)
                return true
            else
                return true
            end
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5035) and arg1:HasSpecialEffectId(TARGET_SELF, 17452) == true then
        if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 5) then
            return true
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 20) then
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5036) and arg1:HasSpecialEffectId(TARGET_SELF, 17452) == true and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 240, 180, 5) then
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5037) and arg1:HasSpecialEffectId(TARGET_SELF, 17452) == true then
        if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 5) then
            return true
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 20) then
            if arg1:GetNumber(0) >= 3 then
...
RegisterTableGoal(GOAL_MagicMercenary_370400_AfterAttackAct, "MagicMercenary_370400_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_MagicMercenary_370400_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)

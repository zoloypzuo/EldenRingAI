...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    elseif f2_local5 == 1 and arg1:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Torimaki then
        if f2_local3 >= 15 then
            ...
            f2_local0[4] = 30
            f2_local0[30] = 70
            if arg1:HasSpecialEffectId(TARGET_SELF, 14052) then
                f2_local0[4] = 0
                f2_local0[9] = 30
            end
        end
    ...
    elseif f2_local3 >= 3 then
        ...
        f2_local0[6] = 30
        f2_local0[9] = 0
    elseif InsideRange(arg1, arg2, 180, 160, 0, 99) then
        f2_local0[4] = 20
        f2_local0[5] = 80
    else
        f2_local0[4] = 70
    ...
    if arg1:HasSpecialEffectId(TARGET_SELF, 14052) == false then
        f2_local0[9] = 0
    end
    f2_local0[6] = SetCoolTime(arg1, arg2, 3003, 10, f2_local0[6], 0)
    f2_local0[11] = SetCoolTime(arg1, arg2, 3009, 20, f2_local0[11], 0)
    f2_local0[5] = SetCoolTime(arg1, arg2, 3007, 10, f2_local0[5], 0)
    f2_local0[9] = SetCoolTime(arg1, arg2, 3010, 10, f2_local0[9], 1)
    f2_local1[1] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act01)
    f2_local1[2] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act02)
    f2_local1[3] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act03)
    f2_local1[4] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act04)
    f2_local1[5] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act05)
    f2_local1[6] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act06)
    f2_local1[7] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act07)
    f2_local1[8] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act08)
    f2_local1[9] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act09)
    f2_local1[10] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act10)
    f2_local1[11] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act11)
    f2_local1[30] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act30)
    f2_local1[31] = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_Act31)
    local f2_local6 = REGIST_FUNC(arg1, arg2, BalloonDoll_385010_ActAfter_AdjustSpace)
    Common_Battle_Activate(arg1, arg2, f2_local0, f2_local1, f2_local6, f2_local2)
    
end

function BalloonDoll_385010_Act01(arg0, arg1, arg2)
    local f3_local0 = 2.2 - arg0:GetMapHitRadius(TARGET_SELF)
    ...
    local f3_local8 = 2.2 - arg0:GetMapHitRadius(TARGET_SELF)
    local f3_local9 = 0
    local f3_local10 = 0
...
function BalloonDoll_385010_Act02(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act03(arg0, arg1, arg2)
    ...
    local f5_local8 = 2.7 - arg0:GetMapHitRadius(TARGET_SELF)
    local f5_local9 = 0
    local f5_local10 = 0
...
function BalloonDoll_385010_Act04(arg0, arg1, arg2)
    local f6_local0 = 2.2 - arg0:GetMapHitRadius(TARGET_SELF)
    ...
    local f6_local10 = 2
    local f6_local11 = 3
    local f6_local12 = 5 - arg0:GetMapHitRadius(TARGET_SELF)
    local f6_local13 = 0
    local f6_local14 = 0
    arg0:AddObserveSpecialEffectAttribute(TARGET_SELF, 5029)
    arg0:AddObserveSpecialEffectAttribute(TARGET_SELF, 5031)
    arg1:AddSubGoal(GOAL_COMMON_ComboAttackTunableSpin, 10, f6_local7, TARGET_ENE_0, f6_local10, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, f6_local8, TARGET_ENE_0, f6_local11, 0, 0, 0, 0)
    arg1:AddSubGoal(GOAL_COMMON_ComboFinal, 10, f6_local9, TARGET_ENE_0, f6_local12, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

function BalloonDoll_385010_Act05(arg0, arg1, arg2)
    ...
    local f7_local8 = 2.5 - arg0:GetMapHitRadius(TARGET_SELF)
    local f7_local9 = 0
    local f7_local10 = 0
    arg0:AddObserveSpecialEffectAttribute(TARGET_SELF, 5029)
    arg0:AddObserveSpecialEffectAttribute(TARGET_SELF, 5031)
...
function BalloonDoll_385010_Act06(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act07(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act08(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act09(arg0, arg1, arg2)
    local f11_local0 = 11 - arg0:GetMapHitRadius(TARGET_SELF)
    ...
    local f11_local8 = 11 - arg0:GetMapHitRadius(TARGET_SELF)
    local f11_local9 = 0
    local f11_local10 = 0
    if arg0:HasSpecialEffectId(TARGET_SELF, 14053) then
        f11_local7 = 3011
    end
...
function BalloonDoll_385010_Act10(arg0, arg1, arg2)
    ...
    local f12_local8 = 8.5 - arg0:GetMapHitRadius(TARGET_SELF)
    local f12_local9 = 0
    local f12_local10 = 0
...
function BalloonDoll_385010_Act11(arg0, arg1, arg2)
    local f13_local0 = 3009
    local f13_local1 = 99.5 - arg0:GetMapHitRadius(TARGET_SELF)
    local f13_local2 = 0
    local f13_local3 = 0
    arg1:AddSubGoal(GOAL_COMMON_ComboRepeat, 10, f13_local0, TARGET_ENE_0, f13_local1, f13_local2, f13_local3, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

function BalloonDoll_385010_Act15(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act16(arg0, arg1, arg2)
    local f15_local0 = 50
...
function BalloonDoll_385010_Act17(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act30(arg0, arg1, arg2)
...
function BalloonDoll_385010_Act31(arg0, arg1, arg2)
    local f18_local0 = arg0:GetDist(TARGET_ENE_0)
    local f18_local1 = arg0:GetRandam_Float(2, 4)
    local f18_local2 = arg0:GetRandam_Float(9, 14)
    local f18_local3 = -1
...
function BalloonDoll_385010_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_BalloonDoll_385010_AfterAttackAct, 10)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5029) then
        if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_L, 90, 140, 2) then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 2, 3004, TARGET_ENE_0, 999, 0, 0)
            return true
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_R, 90, 140, 2) then
            arg2:ClearSubGoal()
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 2, 3005, TARGET_ENE_0, 999, 0, 0)
            return true
        else
    ...
    if arg1:IsInterupt(INTERUPT_Damaged) then
        ...
        if f22_local0 <= 25 and arg1:GetRemainingAttackCoolTime(3009) == 0 then
            arg2:ClearSubGoal()
            BalloonDoll_385010_Act11(arg1, arg2)
            return true
        end
    end
    return false

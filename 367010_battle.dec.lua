RegisterTableGoal(GOAL_WitheredLeg_BlackCloak_367010_Battle, "WitheredLeg_BlackCloak_367010_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_WitheredLeg_BlackCloak_367010_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    if f2_local7 == 1 and arg1:GetTeamOrder(ORDER_TYPE_Role) == ROLE_TYPE_Kankyaku then
        if arg1:HasSpecialEffectId(TARGET_SELF, 17104) == true then
        ...
        elseif arg1:HasSpecialEffectId(TARGET_SELF, 17104) == false then
            if f2_local3 >= 30 then
                if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 100) then
                    f2_local0[1] = 0
                    f2_local0[2] = 0
    ...
    elseif arg1:HasSpecialEffectId(TARGET_SELF, 17104) == true then
        if f2_local3 >= 30 then
            if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 100) then
                f2_local0[1] = 0
                f2_local0[2] = 0
    ...
    f2_local0[4] = SetCoolTime(arg1, arg2, 3013, 15, f2_local0[4], 0)
    f2_local1[1] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act1)
    f2_local1[2] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act2)
    f2_local1[3] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act3)
    f2_local1[4] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act4)
    f2_local1[20] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act20)
    f2_local1[21] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act21)
    f2_local1[22] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_Act22)
    f2_local1[23] = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367000_Act23)
    local f2_local8 = REGIST_FUNC(arg1, arg2, WitheredLeg_BlackCloak_367010_ActAfter_AdjustSpace)
    Common_Battle_Activate(arg1, arg2, f2_local0, f2_local1, f2_local8, f2_local2)
    
end

function WitheredLeg_BlackCloak_367010_Act1(arg0, arg1, arg2)
...
function WitheredLeg_BlackCloak_367010_Act2(arg0, arg1, arg2)
...
function WitheredLeg_BlackCloak_367010_Act3(arg0, arg1, arg2)
    local f5_local0 = 50 - arg0:GetMapHitRadius(TARGET_SELF)
...
function WitheredLeg_BlackCloak_367010_Act4(arg0, arg1, arg2)
...
function WitheredLeg_BlackCloak_367010_Act20(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_ApproachTarget, 3, TARGET_ENE_0, 25, TARGET_ENE_0, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

function WitheredLeg_BlackCloak_367010_Act21(arg0, arg1, arg2)
...
function WitheredLeg_BlackCloak_367010_Act22(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_COMMON_SidewayMove, arg0:GetRandam_Float(2, 2.5), TARGET_ENE_0, arg0:GetRandam_Int(0, 1), arg0:GetRandam_Int(30, 45), true, true, -1)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
...
function WitheredLeg_BlackCloak_367010_Act23(arg0, arg1, arg2)
...
function WitheredLeg_BlackCloak_367010_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_WitheredLeg_BlackCloak_367010_AfterAttackAct, 10)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5025) and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 140, 180, 2.5) then
        arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3011, TARGET_ENE_0, 999, 0, 0, 0, 0)
        return true
    end
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:GetSpecialEffectActivateInterruptId(5026) then
        if arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 140, 180, 2.5) then
            arg2:AddSubGoal(GOAL_COMMON_ComboFinal, 10, 3011, TARGET_ENE_0, 999, 0, 0, 0, 0)
            return true
        elseif arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_ENE_0, AI_DIR_TYPE_F, 120, 180, 4) then
            return true
...
RegisterTableGoal(GOAL_WitheredLeg_BlackCloak_367010_AfterAttackAct, "WitheredLeg_BlackCloak_367010_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_WitheredLeg_BlackCloak_367010_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)

function Wildboar605000_Logic(arg0)
        ...
        elseif f1_local2 == 110 then
            ...
            if arg0:IsBattleState() == false and arg0:IsSearchLowState() == false and arg0:IsSearchHighState() == false and arg0:IsCautionState() == false and arg0:IsMemoryState() == false and f1_local1 == -1 then
                ...
                if f1_local5 == f1_local6 then
                    ...
                    local f1_local15 = arg0:GetRandam_Int(1, 100)
                    local f1_local16 = 5
                    local f1_local17 = 3021
                    local f1_local18 = TARGET_SELF
                    local f1_local19 = 10
                    if f1_local8 == 3022 then
                        f1_local17 = 3023
                    end
                    arg0:AddTopGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, f1_local16, f1_local17, f1_local18, f1_local19)
                    if f1_local15 >= 70 then
                        arg0:AddTopGoal(GOAL_COMMON_ComboRepeat_SuccessAngle180, f1_local16, f1_local17, f1_local18, f1_local19)
                    end
                else
...
function Wildboar605000_Interupt(arg0, arg1)
    return false

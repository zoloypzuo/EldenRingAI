RegisterTableGoal(GOAL_Bird600000_Battle, "GOAL_Bird600000_Battle")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_Bird600000_Battle, true)
...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local1[1] = REGIST_FUNC(arg1, arg2, Bird600000_Act01)
    f2_local1[20] = REGIST_FUNC(arg1, arg2, Bird600000_Act20)
    local f2_local8 = REGIST_FUNC(arg1, arg2, Bird600000_ActAfter_AdjustSpace)
    Common_Battle_Activate(arg1, arg2, f2_local0, f2_local1, f2_local8, f2_local2)
    
end

function Bird600000_Act01(arg0, arg1, arg2)
...
function Bird600000_Act20(arg0, arg1, arg2)
    arg0:AddObserveSpecialEffectAttribute(TARGET_SELF, 5025)
    arg1:AddSubGoal(GOAL_COMMON_Wait, arg0:GetRandam_Float(1, 1.5), TARGET_SELF, 0, 0, 0)
    GetWellSpace_Odds = 0
    return GetWellSpace_Odds
    
end

function Bird600000_ActAfter_AdjustSpace(arg0, arg1, arg2)
    arg1:AddSubGoal(GOAL_Bird600000_AfterAttackAct, 10)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    local f8_local2 = 0
    local f8_local3 = 0
    local f8_local4 = arg1:GetRandam_Int(1, 100)
    local f8_local5 = arg1:GetHpRate(TARGET_SELF)
    if arg1:HasSpecialEffectId(TARGET_SELF, 5110) == true or arg1:HasSpecialEffectAttribute(TARGET_SELF, SP_EFFECT_TYPE_SLEEP) == true then
        return false
    end
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:HasSpecialEffectId(TARGET_SELF, 5039) == false and arg1:GetSpecialEffectActivateInterruptId(5025) and arg1:IsInsideTargetCustom(TARGET_SELF, TARGET_SOUND, AI_DIR_TYPE_F, 360, 180, 6) then
        if f8_local4 <= 70 then
            arg2:ClearSubGoal()
...
RegisterTableGoal(GOAL_Bird600000_AfterAttackAct, "GOAL_Bird600000_AfterAttackAct")
REGISTER_GOAL_NO_SUB_GOAL(GOAL_Bird600000_AfterAttackAct, true)
Goal.Activate = function (arg0, arg1, arg2)

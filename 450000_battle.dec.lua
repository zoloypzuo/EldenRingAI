...
Goal.Activate = function (arg0, arg1, arg2)
    ...
    f2_local1[1] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act01)
    f2_local1[2] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act02)
    f2_local1[3] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act03)
    f2_local1[4] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act04)
    f2_local1[5] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act05)
    f2_local1[6] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act06)
    f2_local1[7] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act07)
    f2_local1[8] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act08)
    f2_local1[9] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act09)
    f2_local1[10] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act10)
    f2_local1[11] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act11)
    f2_local1[12] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act12)
    f2_local1[13] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act13)
    f2_local1[14] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act14)
    f2_local1[15] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act15)
    f2_local1[16] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act16)
    f2_local1[17] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act17)
    f2_local1[18] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act18)
    f2_local1[19] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act19)
    f2_local1[20] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act20)
    f2_local1[25] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act25)
    f2_local1[30] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act30)
    f2_local1[31] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act31)
    f2_local1[32] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act32)
    f2_local1[35] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act35)
    f2_local1[36] = REGIST_FUNC(arg1, arg2, Wyvern450000_Act36)
    local f2_local8 = REGIST_FUNC(arg1, arg2, Wyvern450000_ActAfter_AdjustSpace)
...
Goal.Interrupt = function (arg0, arg1, arg2)
    ...
    if arg1:IsInterupt(INTERUPT_ActivateSpecialEffect) and arg1:HasSpecialEffectId(TARGET_SELF, 5026) then
        arg2:ClearSubGoal()
        local f32_local6 = arg1:GetDist(TARGET_ENE_0)
        if arg1:IsInsideTarget(TARGET_ENE_0, AI_DIR_TYPE_F, 120) and f32_local6 >= 20 then
            local f32_local7 = 5
            local f32_local8 = 3001
            local f32_local9 = TARGET_ENE_0
            local f32_local10 = TARGET_SELF
            local f32_local11 = 10
            local f32_local12 = 0
            local f32_local13 = 0
            local f32_local14 = 0
            arg2:AddSubGoal(GOAL_COMMON_ComboRepeat, f32_local7, f32_local8, f32_local9, successDist2)
        end
        return true
    end
